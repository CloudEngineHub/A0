...
def interpolate_and_add(dtraj2d):
    """
    Given a (4,2) numpy array representing 4 (x, y) points,
    this function interpolates the midpoint between the last two points
    and inserts it at the 4th index, returning a (5,2) array.
