...
class DroidWaypointDatasetCotracker(Dataset):
    def __init__(self,
                 split='train',
                 sample_rate=5,
                 first_frame=False):
        self.DATASET_NAME = "droid_cotrack"
        ...
        self.data_root=config['dataset']['droid_cotrack_path']
        ...
        logging.info("Totally {} samples in DROID_cotrack {} set.".format(self.data_num, split))
...
if __name__ == "__main__":
    ...
    Dataset = DroidWaypointDatasetCotracker(split='test')
