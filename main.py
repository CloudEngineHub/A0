...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default="Qwen2.5-7B",
        choices=["Qwen2.5-7B", "t5-v1_1-xxl"],
        help="The text encoder to use. Choose between ['Qwen2.5-7B', 't5-v1_1-xxl']. Default is Qwen2.5-7B.",
    )
    ...
    parser.add_argument(
        "--train_datasets",type=str,default="all",choices=["all", "hoi4d", "droid", "maniskill"],
        help="The datasets to use for training. Choose between ['all', 'hoi4d', 'droid', 'maniskill']. Default is all.")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "   - a path to a *directory* containing model weights saved using [`~DiTRunner.save_pretrained`] method, e.g., `./my_model_directory/`.\n"
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Whether or not to apply flip and rotate augmentation to the input images.",
    )
    parser.add_argument(
        "--precomp_lang_embed",
        action="store_true",
